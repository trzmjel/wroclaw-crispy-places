...
(1,	5,	'JAK TO ZOSTAŁO NAMALOWANE? (PANORAMA RACŁAWICKA)'),
(2,	10,	'POŚRÓD DZIKICH ZWIĘRZĄT! (WROCŁAWSKIE ZOO)'),
(3,	15,	'AZJA WZYWA! (OGRÓD JAPOŃSKI)'),
(4,	20,	'SPOTKANIE Z HISTORIĄ! (MUZEUM NARODOWE)'),
(5,	25,	'W GŁĘBINACH OCEANU! (HYDROPOLIS)'),
(6,	30,	'WODNE ATRAKCJE! (FONTANNY BLISKO HALI STULECIA)'),
(7,	35,	'NASTĘPNY PRZYSTANEK... (KOLEJKOWO)'),
(8,	40,	'PODNIEBNA PRZEPRAWA! (POLINKA PWR)'),
